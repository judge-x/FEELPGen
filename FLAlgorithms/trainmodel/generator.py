...
class Generator(nn.Module):
    def __init__(self, dataset='mnist', model='cnn', embedding=False, latent_layer_idx=-1,device="cpu"):
...
class DiversityLoss(nn.Module):
    ...
    def compute_distance(self, tensor1, tensor2, metric='l2'):
        """
