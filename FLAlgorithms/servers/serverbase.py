...
class Server:
    def __init__(self, args, model, seed, gpu_idx):
        # Set up the main attributes
        gpu_id=gpu_idx
        # if args.device=='cpu':
        #     self.device = args.device
        # else:
        #     self.device=args.device+str(gpu_id)
        self.device =torch.device(str(gpu_id) if args.device=='cuda' else "cpu")
        self.dataset = args.dataset
        self.num_glob_iters = args.num_mid_iters
